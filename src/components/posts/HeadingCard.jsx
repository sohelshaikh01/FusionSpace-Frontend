...
const HeadingCard = ({ post }) => {
  return (
    <Link 
      ...
      className="rounded-xl p-4 bg-slate-300 dark:bg-[#1A1A1A] border border-[var(--glass-border)] dark:border-white/5 shadow-[0_7px_10px_rgba(0,0,0,0.10] dark:shadow-[0_7px_10px_rgba(0,0,0,0.40)]  hover:border-[var(--accent-focus)] transition-all"
    >
